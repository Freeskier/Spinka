...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20210716150503_add permissions table")]
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 16, 17, 5, 3, 122, DateTimeKind.Local).AddTicks(5113));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 16, 17, 5, 3, 142, DateTimeKind.Local).AddTicks(4068));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 16, 17, 5, 3, 159, DateTimeKind.Local).AddTicks(8433));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 16, 17, 5, 3, 169, DateTimeKind.Local).AddTicks(1691));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 16, 17, 5, 3, 169, DateTimeKind.Local).AddTicks(3720));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 16, 17, 5, 3, 181, DateTimeKind.Local).AddTicks(6621));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockControl", b =>
                {
                    ...
                    b.Property<DateTime>("LastTimeModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 16, 17, 5, 3, 190, DateTimeKind.Local).AddTicks(2069));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.MajorEvent", b =>
                {
                    ...
                    b.HasOne("Spinka.Domain.Models.UnitDepartment", "UnitDepartment")
                        .WithOne("MajorEvent")
                        .HasForeignKey("Spinka.Domain.Models.MajorEvent", "UnitDepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
