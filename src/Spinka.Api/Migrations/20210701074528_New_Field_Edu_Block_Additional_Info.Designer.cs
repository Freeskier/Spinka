...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20210701074528_New_Field_Edu_Block_Additional_Info")]
    partial class New_Field_Edu_Block_Additional_Info
    {
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 1, 9, 45, 28, 418, DateTimeKind.Local).AddTicks(7837));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 1, 9, 45, 28, 437, DateTimeKind.Local).AddTicks(7876));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 1, 9, 45, 28, 453, DateTimeKind.Local).AddTicks(7125));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 1, 9, 45, 28, 459, DateTimeKind.Local).AddTicks(9194));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 1, 9, 45, 28, 460, DateTimeKind.Local).AddTicks(2110));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 1, 9, 45, 28, 468, DateTimeKind.Local).AddTicks(3027));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockControl", b =>
                {
                    ...
                    b.Property<DateTime>("LastTimeModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 1, 9, 45, 28, 471, DateTimeKind.Local).AddTicks(8439));
