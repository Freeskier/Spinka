...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20210629163111_Fix_All_Bugs")]
    partial class Fix_All_Bugs
    {
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 29, 18, 31, 10, 872, DateTimeKind.Local).AddTicks(4449));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 29, 18, 31, 10, 891, DateTimeKind.Local).AddTicks(3692));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 29, 18, 31, 10, 907, DateTimeKind.Local).AddTicks(7912));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 29, 18, 31, 10, 914, DateTimeKind.Local).AddTicks(705));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 29, 18, 31, 10, 914, DateTimeKind.Local).AddTicks(3426));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 29, 18, 31, 10, 922, DateTimeKind.Local).AddTicks(3856));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockControl", b =>
                {
                    ...
                    b.Property<DateTime>("LastTimeModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 29, 18, 31, 10, 925, DateTimeKind.Local).AddTicks(9771));
