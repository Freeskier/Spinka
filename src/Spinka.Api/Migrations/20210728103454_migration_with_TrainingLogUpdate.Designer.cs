...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20210728103454_migration_with_TrainingLogUpdate")]
    partial class migration_with_TrainingLogUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AdditionalPersonnel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 235, DateTimeKind.Local).AddTicks(5275));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 250, DateTimeKind.Local).AddTicks(308));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AuthorizationsTypePermissions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AuthorizationsTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AuthorizationsTypeId");

                    b.HasIndex("PermissionId");

                    b.ToTable("AuthorizationsTypePermissions");
                });
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 264, DateTimeKind.Local).AddTicks(2773));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 269, DateTimeKind.Local).AddTicks(4852));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 269, DateTimeKind.Local).AddTicks(6438));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 277, DateTimeKind.Local).AddTicks(2258));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockControl", b =>
                {
                    ...
                    b.Property<DateTime>("LastTimeModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 279, DateTimeKind.Local).AddTicks(8503));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 28, 12, 34, 54, 284, DateTimeKind.Local).AddTicks(2204));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockSubject", b =>
                {
                    ...
                    b.Property<int?>("TypeOfRequirement")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spinka.Domain.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Spinka.Domain.Models.TrainingArea", b =>
                {
                    ...
                    b.Property<string>("TrainingAcronym")
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AuthorizationsTypePermissions", b =>
                {
                    b.HasOne("Spinka.Domain.Models.AuthorizationsType", "AuthorizationsType")
                        .WithMany("AuthorizationsTypePermissions")
                        .HasForeignKey("AuthorizationsTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Spinka.Domain.Models.Permission", "Permission")
                        .WithMany("AuthorizationsTypePermissions")
