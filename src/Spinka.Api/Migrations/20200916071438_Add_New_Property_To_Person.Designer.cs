...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20200916071438_Add_New_Property_To_Person")]
    partial class Add_New_Property_To_Person
    {
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2020, 9, 16, 9, 14, 38, 594, DateTimeKind.Local).AddTicks(3296));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 16, 9, 14, 38, 615, DateTimeKind.Local).AddTicks(370));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 16, 9, 14, 38, 630, DateTimeKind.Local).AddTicks(2955));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 16, 9, 14, 38, 634, DateTimeKind.Local).AddTicks(9463));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 16, 9, 14, 38, 635, DateTimeKind.Local).AddTicks(2552));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 16, 9, 14, 38, 643, DateTimeKind.Local).AddTicks(6449));
