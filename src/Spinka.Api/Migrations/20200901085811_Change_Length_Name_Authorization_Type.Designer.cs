...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20200901085811_Change_Length_Name_Authorization_Type")]
    partial class Change_Length_Name_Authorization_Type
    {
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2020, 9, 1, 10, 58, 10, 605, DateTimeKind.Local).AddTicks(2436));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 1, 10, 58, 10, 622, DateTimeKind.Local).AddTicks(9432));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 1, 10, 58, 10, 636, DateTimeKind.Local).AddTicks(9575));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 1, 10, 58, 10, 641, DateTimeKind.Local).AddTicks(7340));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 1, 10, 58, 10, 650, DateTimeKind.Local).AddTicks(8126));
