...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20210803124547_Add Medical Service Type")]
    partial class AddMedicalServiceType
    {
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 659, DateTimeKind.Local).AddTicks(3327));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 678, DateTimeKind.Local).AddTicks(1980));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 703, DateTimeKind.Local).AddTicks(2663));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 713, DateTimeKind.Local).AddTicks(186));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 713, DateTimeKind.Local).AddTicks(3309));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 727, DateTimeKind.Local).AddTicks(6259));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockControl", b =>
                {
                    ...
                    b.Property<DateTime>("LastTimeModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 731, DateTimeKind.Local).AddTicks(9388));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlockHistory", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 3, 14, 45, 46, 739, DateTimeKind.Local).AddTicks(3632));
