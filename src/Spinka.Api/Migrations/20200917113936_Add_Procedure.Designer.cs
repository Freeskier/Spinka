...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20200917113936_Add_Procedure")]
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2020, 9, 17, 13, 39, 35, 897, DateTimeKind.Local).AddTicks(8980));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 17, 13, 39, 35, 932, DateTimeKind.Local).AddTicks(2111));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 17, 13, 39, 35, 952, DateTimeKind.Local).AddTicks(6878));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 17, 13, 39, 35, 958, DateTimeKind.Local).AddTicks(9296));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 17, 13, 39, 35, 959, DateTimeKind.Local).AddTicks(1855));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 17, 13, 39, 35, 970, DateTimeKind.Local).AddTicks(108));
