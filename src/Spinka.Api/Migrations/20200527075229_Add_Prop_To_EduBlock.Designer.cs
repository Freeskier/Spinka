...
namespace Spinka.Api.Migrations
{
    ...
    [Migration("20200527075229_Add_Prop_To_EduBlock")]
    partial class Add_Prop_To_EduBlock
    {
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AmmoTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 27, 9, 52, 29, 186, DateTimeKind.Local).AddTicks(5685));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.AssignedTrainingFacility", b =>
                {
                    ...
                    b.Property<DateTime>("ApprovedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 27, 9, 52, 29, 198, DateTimeKind.Local).AddTicks(8756));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.CurrentAmmoLimitsForDepartment", b =>
                {
                    ...
                    b.Property<DateTime>("ActualizationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 27, 9, 52, 29, 207, DateTimeKind.Local).AddTicks(4863));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.DayRep", b =>
                {
                    ...
                    b.Property<DateTime>("Day")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 27, 9, 52, 29, 211, DateTimeKind.Local).AddTicks(6129));
            ...
            modelBuilder.Entity("Spinka.Domain.Models.EduBlock", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprovedTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 27, 9, 52, 29, 214, DateTimeKind.Local).AddTicks(2513));
                    ...
                    b.Property<int?>("SecurityPersonId1")
                        .HasColumnType("int");

                    b.Property<int?>("SecurityPersonId2")
                        .HasColumnType("int");

                    b.Property<int?>("SecurityPersonId3")
                        .HasColumnType("int");

                    b.Property<int?>("SecurityPersonId4")
                        .HasColumnType("int");
