...
{
    public class GetEduBlocksQueryHandler : IQueryHandler<GetEduBlocks, IEnumerable<EduBlockViewModel>>
    {
        private readonly IMapper _mapper;
        private readonly SpinkaContext _context;

        public GetEduBlocksQueryHandler(IMapper mapper, SpinkaContext context)
        {
            _mapper = mapper;
            _context = context;
        }
        
        public async Task<IEnumerable<EduBlockViewModel>> HandleAsync(GetEduBlocks query)
        {
